...
(function(addon) {
    ...
    UI.component('htmleditor', {
        ...
        defaults: {
            ...
            toolbar      : [ 'heading1', 'heading2', 'heading3', 'heading4', 'bold', 'italic', 'strike', 'link', 'image', 'blockquote', 'listUl', 'listOl' ],
            lblPreview   : 'Preview',
            lblCodeview  : 'HTML',
    ...
    UI.plugin('htmleditor', 'base', {
        ...
        init: function(editor) {
            ...
            addAction('heading1', '<h1>$1</h1>');
            addAction('heading2', '<h2>$1</h2>');
            addAction('heading3', '<h3>$1</h3>');
            addAction('heading4', '<h4>$1</h4>');
    ...
    UI.plugin('htmleditor', 'markdown', {
        ...
        init: function(editor) {
            ...
            addAction('heading1', '# $1');
            addAction('heading2', '## $1');
            addAction('heading3', '### $1');
            addAction('heading4', '#### $1');
            addAction('bold', '**$1**');
            addAction('italic', '*$1*');
            addAction('strike', '~~$1~~');
